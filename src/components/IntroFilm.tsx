...
const INTRO_FILM_SRC = "/assets/video/cookie-29-intro-web.mp4";
const INTRO_POSTER_SRC = "/assets/video/cookie-29-intro-poster.jpg";
const INTRO_LAST_FRAME_SRC = "/assets/video/cookie-29-intro-last-frame.jpg";
